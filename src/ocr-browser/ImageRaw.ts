...
import { ImageRawBase } from "../ocr-common";
import type { ImageRawData, LineImage, SizeOption } from "../ocr-common";
import invariant from "tiny-invariant";

/**
 * Worker-only version: strictly OffscreenCanvas + createImageBitmap.
 * No fallbacks to Image or DOM canvas.
 */
...
export class ImageRaw extends ImageRawBase {
  ...
  /**
   * Return a Blob from OffscreenCanvas.convertToBlob()
   * (worker -> main thread transferable)
   */
