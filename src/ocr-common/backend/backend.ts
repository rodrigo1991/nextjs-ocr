...
let InferenceSession: InferenceSessionType | any =
  undefined as unknown as InferenceSessionType;
let splitIntoLineImages: SplitIntoLineImagesType =
  undefined as unknown as SplitIntoLineImagesType;
let defaultModels: ModelCreateOptionsType["models"] =
  undefined as unknown as ModelCreateOptionsType["models"];
